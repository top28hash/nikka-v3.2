...
smd({
  ...
  try {
    ...
    const apiUrl = `https://ironman.koyeb.app/ironman/dl/tiktokdl?url=${videoUrl}`;
    ...
    return _0x2c2023.error(_0x86b411 + "\n\ncommand: tt2", _0x86b411, "*_Error occurred while processing the command!!_*");
  }
});
